...
// Every concrete effect (Attack, Heal, Defend, Crit, Miss, and anything
// custom you add later like Poison or Stun) inherits from this and
// implements its own Execute() with its own tunable fields.
//
